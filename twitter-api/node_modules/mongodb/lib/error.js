...
exports.isResumableError = exports.isNetworkTimeoutError = exports.isSDAMUnrecoverableError = exports.isNodeShuttingDownError = exports.isRetryableError = exports.isRetryableWriteError = exports.MongoWriteConcernError = exports.MongoServerSelectionError = exports.MongoSystemError = exports.MongoParseError = exports.MongoNetworkTimeoutError = exports.MongoNetworkError = exports.isNetworkErrorBeforeHandshake = exports.MongoTopologyClosedError = exports.MongoStreamClosedError = exports.MongoCursorExhaustedError = exports.MongoServerClosedError = exports.MongoResourceClosedError = exports.MongoCursorInUseError = exports.MongoGridFSChunkError = exports.MongoGridFSStreamError = exports.MongoTailableCursorError = exports.MongoChangeStreamError = exports.MongoStreamError = exports.MongoCursorError = exports.MongoKerberosError = exports.MongoExpiredSessionError = exports.MongoTransactionError = exports.MongoNotConnectedError = exports.MongoDecompressionError = exports.MongoCompressionError = exports.MongoURIError = exports.MongoBatchReExecutionError = exports.MongoRuntimeError = exports.MongoDriverError = exports.MongoServerError = exports.MongoError = exports.GET_MORE_RESUMABLE_CODES = exports.MONGODB_ERROR_CODES = void 0;
/** @internal */
 ...
 * @category Error
 */
class MongoBatchReExecutionError extends MongoRuntimeError {
    constructor(message) {
        super(message);
    }
    get name() {
 ...
 * @category Error
 */
class MongoURIError extends MongoRuntimeError {
    constructor(message) {
        super(message);
    }
    get name() {
...
exports.MongoURIError = MongoURIError;
/**
 ...
 * @category Error
 */
class MongoCompressionError extends MongoRuntimeError {
    constructor(message) {
        super(message);
    }
    get name() {
...
exports.MongoCompressionError = MongoCompressionError;
/**
 ...
 * @category Error
 */
class MongoNotConnectedError extends MongoRuntimeError {
    constructor(message) {
        super(message);
    }
    get name() {
 ...
 * @category Error
 */
class MongoTransactionError extends MongoRuntimeError {
    constructor(message) {
        super(message);
    }
    get name() {
 ...
 * @category Error
 */
class MongoExpiredSessionError extends MongoRuntimeError {
    constructor(message) {
        super(message);
    }
    get name() {
 ...
 * @category Error
 */
class MongoCursorError extends MongoRuntimeError {
    constructor(message) {
        super(message);
    }
    get name() {
...
exports.MongoCursorError = MongoCursorError;
/**
 ...
 * @category Error
 */
class MongoStreamError extends MongoRuntimeError {
    constructor(message) {
        super(message);
    }
    get name() {
...
exports.MongoStreamError = MongoStreamError;
/**
 ...
 * @category Error
 */
class MongoChangeStreamError extends MongoStreamError {
    constructor(message) {
        super(message);
    }
    get name() {
 ...
 * @category Error
 */
class MongoTailableCursorError extends MongoCursorError {
    constructor(message) {
        super(message);
    }
    get name() {
 ...
 * @category Error
 */
class MongoGridFSStreamError extends MongoStreamError {
    constructor(message) {
        super(message);
    }
    get name() {
 ...
 * @category Error
 */
class MongoGridFSChunkError extends MongoStreamError {
    constructor(message) {
        super(message);
    }
    get name() {
 ...
 * @category Error
 */
class MongoCursorInUseError extends MongoCursorError {
    constructor(message) {
        super(message);
    }
    get name() {
 ...
 * @category Error
 */
class MongoResourceClosedError extends MongoRuntimeError {
    constructor(message) {
        super(message);
    }
    get name() {
...
exports.MongoResourceClosedError = MongoResourceClosedError;
/**
 ...
 * @category Error
 */
class MongoServerClosedError extends MongoResourceClosedError {
    constructor(message) {
        super(message);
    }
    get name() {
 ...
 * @category Error
 */
class MongoCursorExhaustedError extends MongoCursorError {
    constructor(message) {
        super(message);
    }
    get name() {
 ...
 * @category Error
 */
class MongoStreamClosedError extends MongoResourceClosedError {
    constructor(message) {
        super(message);
    }
    get name() {
...
exports.MongoStreamClosedError = MongoStreamClosedError;
/**
 ...
 * @category Error
 */
class MongoTopologyClosedError extends MongoResourceClosedError {
    constructor(message) {
        super(message);
    }
    get name() {
