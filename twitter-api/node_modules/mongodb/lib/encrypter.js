...
class Encrypter {
    ...
    static checkForMongoCrypt() {
        ...
        try {
            ...
            throw new error_1.MongoDriverError('Auto-encryption requested, but the module is not installed. ' +
        ...
        if (typeof (mongodbClientEncryption === null || mongodbClientEncryption === void 0 ? void 0 : mongodbClientEncryption.extension) !== 'function') {
            throw new error_1.MongoDriverError('loaded version of `mongodb-client-encryption` does not have property `extension`. ' +
